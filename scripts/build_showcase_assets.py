...
def main() -> None:
    ...
    # Keep the bilingual public kit in one manifest.  English artifacts are
    # generated by their dedicated scripts, then included here when present;
    # rebuilding the Chinese assets must not silently drop them.
